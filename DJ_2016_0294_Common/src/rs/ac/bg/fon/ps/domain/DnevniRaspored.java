 ...
 * @author GaGiiiii
 */
public class DnevniRaspored implements IDomain, Serializable {

    private Long dnevni_raspored_id;
    private Date datum;

    public DnevniRaspored() {
        this.dnevni_raspored_id = Long.MIN_VALUE;
    }

    public DnevniRaspored(Long dnevni_raspored_id, Date datum) {
    ...
    public LinkedList<IDomain> getListFromRs(ResultSet rs) throws Exception {
        ...
        while (rs.next()) {
            ...
            DnevniRaspored dnevniRaspored = new DnevniRaspored(id, datum);
    ...
    public String prepareQueryForSelect() {
        return "SELECT * FROM `dnevni_raspored` dnevniraspored";
    }
