...
public class KreirajFilmForm extends javax.swing.JDialog {
    ...
    public KreirajFilmForm(java.awt.Frame parent, boolean modal) {
        ...
        try {
            film = new Film();
            JOptionPane.showMessageDialog(this, "Sistem je kreirao film.", "Kreiranje filma", JOptionPane.INFORMATION_MESSAGE);
        } catch (Exception e) {
    ...
    private void kreirajBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kreirajBtnActionPerformed
        try {
            ...
            if (res.getException() == null) {
                ...
                JOptionPane.showMessageDialog(this, "Sistem ne moze da zapamti film.", "Neuspesno kreiranje filma", JOptionPane.ERROR_MESSAGE);
                res.getException().printStackTrace();
            }
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, "Sistem ne moze da zapamti film.", "Greska prilikom kreiranja", JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
        }
