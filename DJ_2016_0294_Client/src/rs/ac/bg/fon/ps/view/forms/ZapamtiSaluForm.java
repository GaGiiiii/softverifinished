 ...
 * @author GaGiiiii
 */
public class ZapamtiSaluForm extends javax.swing.JDialog {

    Sala sala;

    public ZapamtiSaluForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(parent);
        setTitle("Kreiranje sale");
        sala = new Sala();
    }
    ...
    private void kreirajBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kreirajBtnActionPerformed
        try {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, "Broj mesta mora biti broj", "Greska prilikom pamcenja sale", JOptionPane.ERROR_MESSAGE);
            ...
            sala.setNaziv(nazivf);
            sala.setBroj_mesta(brojMesta);
            sala.setVip_mesta(vipMesta);
            sala.setKlima(klima);
            sala.setHas3D(has3D);
            Response res = ControllerC.getInstance().zapamtiSalu(sala);

            if (res.getException() == null) {
                JOptionPane.showMessageDialog(this, "Sistem je zapamtio salu", "Uspesno zapamcena sala", JOptionPane.INFORMATION_MESSAGE);
                emptyFields();
            } else {
                JOptionPane.showMessageDialog(this, "Sistem ne moze da zapamti salu.", "Neuspesno pamcenje sale", JOptionPane.ERROR_MESSAGE);
                res.getException().printStackTrace();
            }
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, "Sistem ne moze da zapamti salu.", "Greska prilikom pamcenja", JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
        }
