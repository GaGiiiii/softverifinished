...
public class KreirajDnevniRasporedForm extends javax.swing.JDialog {
    ...
    Dnevni_Raspored dnevni_Raspored;
    ...
    public KreirajDnevniRasporedForm(java.awt.Frame parent, boolean modal) {
        ...
        init();
        try {
            dnevni_Raspored = new Dnevni_Raspored();
            JOptionPane.showMessageDialog(this, "Sistem je kreirao dnevni rasproed.", "Kreiranje dnevnog rasproeda", JOptionPane.INFORMATION_MESSAGE);
            JOptionPane.showMessageDialog(this, "Sistem ne moze da kreira dnevni raspored.", "Neuspesno kreiranje dnevnog rasporeda", JOptionPane.ERROR_MESSAGE);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Sistem ne moze da kreira film.", "Kreiranje filma", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void kreirajBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kreirajBtnActionPerformed
        try {
            ...
            if (res.getException() == null) {
                ...
                JOptionPane.showMessageDialog(this, "Sistem ne moze da zapamti dnevni raspored", "Neuspesno kreiranje dnevnog rasporeda", JOptionPane.ERROR_MESSAGE);
                emptyFields();
            } else {
                JOptionPane.showMessageDialog(this, "Sistem ne moze da zapamti dnevni raspored", "Neuspesno kreiranje dnevnog rasporeda", JOptionPane.ERROR_MESSAGE);
            ...
            JOptionPane.showMessageDialog(this, "Sistem ne moze da zapamti dnevni raspored", "Greska prilikom kreiranja dnevnog rasporeda", JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
        }
