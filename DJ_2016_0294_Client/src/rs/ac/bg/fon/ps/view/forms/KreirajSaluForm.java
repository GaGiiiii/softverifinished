...
public class KreirajSaluForm extends javax.swing.JDialog {
    ...
    public KreirajSaluForm(java.awt.Frame parent, boolean modal) {
        ...
        try {
            sala = new Sala();
            JOptionPane.showMessageDialog(this, "Sistem je kreirao salu.", "Kreiranje sale", JOptionPane.INFORMATION_MESSAGE);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Sistem ne moze da kreira salu.", "Kreiranje sale", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void kreirajBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kreirajBtnActionPerformed
        try {
            ...
            if (res.getException() == null) {
                ...
                JOptionPane.showMessageDialog(this, "Sistem ne moze da zapamti salu.", "Neuspesno kreiranje sale", JOptionPane.ERROR_MESSAGE);
                res.getException().printStackTrace();
            }
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, "Sistem ne moze da zapamti salu.", "Greska prilikom kreiranja", JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
        }
