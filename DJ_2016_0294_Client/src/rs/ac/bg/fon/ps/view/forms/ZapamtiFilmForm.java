 ...
 * @author GaGiiiii
 */
public class ZapamtiFilmForm extends javax.swing.JDialog {

    Film film;

    public ZapamtiFilmForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void kreirajBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kreirajBtnActionPerformed
        try {
            ...
            film.setNaziv(nazivf);
            film.setZanr(zanrf);
            film.setTrajanje(trajanjef);
            film.setCena_karte(cenaf);
            film.setReziser(reziserf);
            film.setGlumci(glumcif);
            film.setDatum_izlaska(date2);
            film.setOpis(opisf);

            Response res = ControllerC.getInstance().zapamtiFilm(film);

            if (res.getException() == null) {
                JOptionPane.showMessageDialog(this, "Sistem je zapamtio film", "Uspesno zapamcen film", JOptionPane.INFORMATION_MESSAGE);
                emptyFields();
            } else {
                JOptionPane.showMessageDialog(this, "Sistem ne moze da zapamti film.", "Neuspesno pamcenje filma", JOptionPane.ERROR_MESSAGE);
                res.getException().printStackTrace();
            }
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, "Sistem ne moze da zapamti film.", "Greska prilikom pamcenja", JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
        }
