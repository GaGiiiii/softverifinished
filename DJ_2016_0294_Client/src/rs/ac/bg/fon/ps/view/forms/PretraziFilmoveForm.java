    ...
    private void pretraziBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pretraziBtnActionPerformed
        try {
            ...
            if (res.getException() == null) {
                List<Film> list1 = (List<Film>) res.getResponse();
                if (list1.size() == 0) {
                    JOptionPane.showMessageDialog(this, "Sistem ne moze da nadje filmove po zadatoj vrednosti", "Neuspesno pretrazivanje filmova", JOptionPane.ERROR_MESSAGE);
                } else {
                    tableModel = new FilmTableModel((List<Film>) res.getResponse());
                    filmoviTable.setModel(tableModel);
                    JOptionPane.showMessageDialog(this, "Sistem je pronasao filmove po zadatoj vrednosti", "Uspesno pretrazivanje filmova", JOptionPane.INFORMATION_MESSAGE);
                }
            } else {
                JOptionPane.showMessageDialog(this, "Sistem ne moze da nadje filmove po zadatoj vrednosti", "Neuspesno pretrazivanje filmova", JOptionPane.ERROR_MESSAGE);
            ...
            JOptionPane.showMessageDialog(this, "Sistem ne moze da nadje filmove po zadatoj vrednosti", "Greska prilikom pretrazivanja", JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
        }
